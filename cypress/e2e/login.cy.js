...
describe('Login tests', () => {
    ...
    it('login - email empty', function() {
        ...
        notification.checkEmail('This is a required field.');
      })
    ...
    it('login - password empty', function() {
      ...
      notification.checkPassword('This is a required field.');
      })
      ...
      it('login - wrong password', function() {
        ...
        notification.checkLogin('Invalid login or password.');
      })
      ...
      it('forgot your password?', function() {
        ...
        notification.checkSuccessMessage('you will receive an email with a link to reset your password');
       })
